...
// VcenterDeploymentTask struct for VcenterDeploymentTask
type VcenterDeploymentTask struct {
...
func (o VcenterDeploymentTask) MarshalJSON() ([]byte, error) {
...
type NullableVcenterDeploymentTask struct {
	value *VcenterDeploymentTask
	isSet bool
}

func (v NullableVcenterDeploymentTask) Get() *VcenterDeploymentTask {
	return v.value
}

func (v *NullableVcenterDeploymentTask) Set(val *VcenterDeploymentTask) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterDeploymentTask) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterDeploymentTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterDeploymentTask(val *VcenterDeploymentTask) *NullableVcenterDeploymentTask {
	return &NullableVcenterDeploymentTask{value: val, isSet: true}
}

func (v NullableVcenterDeploymentTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterDeploymentTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
