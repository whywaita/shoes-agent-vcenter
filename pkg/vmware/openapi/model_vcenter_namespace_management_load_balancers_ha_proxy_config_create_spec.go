...
// VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec struct for VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec
type VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec struct {
...
func NewVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec(servers []VcenterNamespaceManagementLoadBalancersServer, username string, password string, certificateAuthorityChain string) *VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec {
	this := VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec{}
...
func (o VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) MarshalJSON() ([]byte, error) {
...
type NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec struct {
	value *VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec
	isSet bool
}

func (v NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) Get() *VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec {
	return v.value
}

func (v *NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) Set(val *VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec(val *VcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) *NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec {
	return &NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec{value: val, isSet: true}
}

func (v NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterNamespaceManagementLoadBalancersHAProxyConfigCreateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
