...
// VapiStdErrorsInvalidArgument struct for VapiStdErrorsInvalidArgument
type VapiStdErrorsInvalidArgument struct {
...
func NewVapiStdErrorsInvalidArgument(messages []VapiStdLocalizableMessage) *VapiStdErrorsInvalidArgument {
	this := VapiStdErrorsInvalidArgument{}
...
func (o VapiStdErrorsInvalidArgument) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsInvalidArgument struct {
	value *VapiStdErrorsInvalidArgument
	isSet bool
}

func (v NullableVapiStdErrorsInvalidArgument) Get() *VapiStdErrorsInvalidArgument {
	return v.value
}

func (v *NullableVapiStdErrorsInvalidArgument) Set(val *VapiStdErrorsInvalidArgument) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsInvalidArgument) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsInvalidArgument) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsInvalidArgument(val *VapiStdErrorsInvalidArgument) *NullableVapiStdErrorsInvalidArgument {
	return &NullableVapiStdErrorsInvalidArgument{value: val, isSet: true}
}

func (v NullableVapiStdErrorsInvalidArgument) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsInvalidArgument) UnmarshalJSON(src []byte) error {
	v.isSet = true
