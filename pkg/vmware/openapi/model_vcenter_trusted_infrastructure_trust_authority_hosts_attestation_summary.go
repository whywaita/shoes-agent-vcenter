...
// VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary struct for VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary
type VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary struct {
	SummaryType VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummaryType `json:"summary_type"`
...
func NewVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary(summaryType VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummaryType) *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary {
	this := VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary{}
...
func (o *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) GetSummaryType() VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummaryType {
	if o == nil {
		var ret VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummaryType
		return ret
	}
...
func (o VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) MarshalJSON() ([]byte, error) {
...
type NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary struct {
	value *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary
	isSet bool
}

func (v NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) Get() *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary {
	return v.value
}

func (v *NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) Set(val *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary(val *VcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) *NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary {
	return &NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary{value: val, isSet: true}
}

func (v NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterTrustedInfrastructureTrustAuthorityHostsAttestationSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
