...
// VapiStdErrorsInternalServerError struct for VapiStdErrorsInternalServerError
type VapiStdErrorsInternalServerError struct {
...
func NewVapiStdErrorsInternalServerError(messages []VapiStdLocalizableMessage) *VapiStdErrorsInternalServerError {
	this := VapiStdErrorsInternalServerError{}
...
func (o VapiStdErrorsInternalServerError) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsInternalServerError struct {
	value *VapiStdErrorsInternalServerError
	isSet bool
}

func (v NullableVapiStdErrorsInternalServerError) Get() *VapiStdErrorsInternalServerError {
	return v.value
}

func (v *NullableVapiStdErrorsInternalServerError) Set(val *VapiStdErrorsInternalServerError) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsInternalServerError) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsInternalServerError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsInternalServerError(val *VapiStdErrorsInternalServerError) *NullableVapiStdErrorsInternalServerError {
	return &NullableVapiStdErrorsInternalServerError{value: val, isSet: true}
}

func (v NullableVapiStdErrorsInternalServerError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsInternalServerError) UnmarshalJSON(src []byte) error {
	v.isSet = true
