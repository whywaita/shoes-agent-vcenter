...
// VapiStdErrorsUnverifiedPeer struct for VapiStdErrorsUnverifiedPeer
type VapiStdErrorsUnverifiedPeer struct {
...
func NewVapiStdErrorsUnverifiedPeer(messages []VapiStdLocalizableMessage) *VapiStdErrorsUnverifiedPeer {
	this := VapiStdErrorsUnverifiedPeer{}
...
func (o VapiStdErrorsUnverifiedPeer) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsUnverifiedPeer struct {
	value *VapiStdErrorsUnverifiedPeer
	isSet bool
}

func (v NullableVapiStdErrorsUnverifiedPeer) Get() *VapiStdErrorsUnverifiedPeer {
	return v.value
}

func (v *NullableVapiStdErrorsUnverifiedPeer) Set(val *VapiStdErrorsUnverifiedPeer) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsUnverifiedPeer) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsUnverifiedPeer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsUnverifiedPeer(val *VapiStdErrorsUnverifiedPeer) *NullableVapiStdErrorsUnverifiedPeer {
	return &NullableVapiStdErrorsUnverifiedPeer{value: val, isSet: true}
}

func (v NullableVapiStdErrorsUnverifiedPeer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsUnverifiedPeer) UnmarshalJSON(src []byte) error {
	v.isSet = true
