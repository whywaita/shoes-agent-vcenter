...
// VapiStdErrorsInvalidElementType struct for VapiStdErrorsInvalidElementType
type VapiStdErrorsInvalidElementType struct {
...
func NewVapiStdErrorsInvalidElementType(messages []VapiStdLocalizableMessage) *VapiStdErrorsInvalidElementType {
	this := VapiStdErrorsInvalidElementType{}
...
func (o VapiStdErrorsInvalidElementType) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsInvalidElementType struct {
	value *VapiStdErrorsInvalidElementType
	isSet bool
}

func (v NullableVapiStdErrorsInvalidElementType) Get() *VapiStdErrorsInvalidElementType {
	return v.value
}

func (v *NullableVapiStdErrorsInvalidElementType) Set(val *VapiStdErrorsInvalidElementType) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsInvalidElementType) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsInvalidElementType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsInvalidElementType(val *VapiStdErrorsInvalidElementType) *NullableVapiStdErrorsInvalidElementType {
	return &NullableVapiStdErrorsInvalidElementType{value: val, isSet: true}
}

func (v NullableVapiStdErrorsInvalidElementType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsInvalidElementType) UnmarshalJSON(src []byte) error {
	v.isSet = true
