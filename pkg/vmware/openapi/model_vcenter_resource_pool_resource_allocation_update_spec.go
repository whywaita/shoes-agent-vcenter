...
// VcenterResourcePoolResourceAllocationUpdateSpec struct for VcenterResourcePoolResourceAllocationUpdateSpec
type VcenterResourcePoolResourceAllocationUpdateSpec struct {
...
func NewVcenterResourcePoolResourceAllocationUpdateSpec() *VcenterResourcePoolResourceAllocationUpdateSpec {
	this := VcenterResourcePoolResourceAllocationUpdateSpec{}
	return &this
}
...
func (o VcenterResourcePoolResourceAllocationUpdateSpec) MarshalJSON() ([]byte, error) {
...
type NullableVcenterResourcePoolResourceAllocationUpdateSpec struct {
	value *VcenterResourcePoolResourceAllocationUpdateSpec
	isSet bool
}

func (v NullableVcenterResourcePoolResourceAllocationUpdateSpec) Get() *VcenterResourcePoolResourceAllocationUpdateSpec {
	return v.value
}

func (v *NullableVcenterResourcePoolResourceAllocationUpdateSpec) Set(val *VcenterResourcePoolResourceAllocationUpdateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterResourcePoolResourceAllocationUpdateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterResourcePoolResourceAllocationUpdateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterResourcePoolResourceAllocationUpdateSpec(val *VcenterResourcePoolResourceAllocationUpdateSpec) *NullableVcenterResourcePoolResourceAllocationUpdateSpec {
	return &NullableVcenterResourcePoolResourceAllocationUpdateSpec{value: val, isSet: true}
}

func (v NullableVcenterResourcePoolResourceAllocationUpdateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterResourcePoolResourceAllocationUpdateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
