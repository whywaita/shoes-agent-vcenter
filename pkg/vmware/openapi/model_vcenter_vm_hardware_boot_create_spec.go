...
// VcenterVmHardwareBootCreateSpec struct for VcenterVmHardwareBootCreateSpec
type VcenterVmHardwareBootCreateSpec struct {
...
func NewVcenterVmHardwareBootCreateSpec() *VcenterVmHardwareBootCreateSpec {
	this := VcenterVmHardwareBootCreateSpec{}
	return &this
}
...
func (o VcenterVmHardwareBootCreateSpec) MarshalJSON() ([]byte, error) {
...
type NullableVcenterVmHardwareBootCreateSpec struct {
	value *VcenterVmHardwareBootCreateSpec
	isSet bool
}

func (v NullableVcenterVmHardwareBootCreateSpec) Get() *VcenterVmHardwareBootCreateSpec {
	return v.value
}

func (v *NullableVcenterVmHardwareBootCreateSpec) Set(val *VcenterVmHardwareBootCreateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterVmHardwareBootCreateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterVmHardwareBootCreateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterVmHardwareBootCreateSpec(val *VcenterVmHardwareBootCreateSpec) *NullableVcenterVmHardwareBootCreateSpec {
	return &NullableVcenterVmHardwareBootCreateSpec{value: val, isSet: true}
}

func (v NullableVcenterVmHardwareBootCreateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterVmHardwareBootCreateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
