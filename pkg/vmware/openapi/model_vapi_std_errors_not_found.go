...
// VapiStdErrorsNotFound struct for VapiStdErrorsNotFound
type VapiStdErrorsNotFound struct {
...
func (o VapiStdErrorsNotFound) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsNotFound struct {
	value *VapiStdErrorsNotFound
	isSet bool
}

func (v NullableVapiStdErrorsNotFound) Get() *VapiStdErrorsNotFound {
	return v.value
}

func (v *NullableVapiStdErrorsNotFound) Set(val *VapiStdErrorsNotFound) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsNotFound) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsNotFound) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsNotFound(val *VapiStdErrorsNotFound) *NullableVapiStdErrorsNotFound {
	return &NullableVapiStdErrorsNotFound{value: val, isSet: true}
}

func (v NullableVapiStdErrorsNotFound) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsNotFound) UnmarshalJSON(src []byte) error {
	v.isSet = true
