...
// VapiStdErrorsAlreadyInDesiredState struct for VapiStdErrorsAlreadyInDesiredState
type VapiStdErrorsAlreadyInDesiredState struct {
...
func NewVapiStdErrorsAlreadyInDesiredState(messages []VapiStdLocalizableMessage) *VapiStdErrorsAlreadyInDesiredState {
	this := VapiStdErrorsAlreadyInDesiredState{}
...
func (o VapiStdErrorsAlreadyInDesiredState) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsAlreadyInDesiredState struct {
	value *VapiStdErrorsAlreadyInDesiredState
	isSet bool
}

func (v NullableVapiStdErrorsAlreadyInDesiredState) Get() *VapiStdErrorsAlreadyInDesiredState {
	return v.value
}

func (v *NullableVapiStdErrorsAlreadyInDesiredState) Set(val *VapiStdErrorsAlreadyInDesiredState) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsAlreadyInDesiredState) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsAlreadyInDesiredState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsAlreadyInDesiredState(val *VapiStdErrorsAlreadyInDesiredState) *NullableVapiStdErrorsAlreadyInDesiredState {
	return &NullableVapiStdErrorsAlreadyInDesiredState{value: val, isSet: true}
}

func (v NullableVapiStdErrorsAlreadyInDesiredState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsAlreadyInDesiredState) UnmarshalJSON(src []byte) error {
	v.isSet = true
