...
// VcenterIdentityProvidersInfo struct for VcenterIdentityProvidersInfo
type VcenterIdentityProvidersInfo struct {
	...
	Oauth2 *VcenterIdentityProvidersOauth2Info `json:"oauth2,omitempty"`
	Oidc *VcenterIdentityProvidersOidcInfo `json:"oidc,omitempty"`
...
func NewVcenterIdentityProvidersInfo(orgIds []string, configTag VcenterIdentityProvidersConfigType, isDefault bool) *VcenterIdentityProvidersInfo {
	this := VcenterIdentityProvidersInfo{}
	this.OrgIds = orgIds
...
func (o *VcenterIdentityProvidersInfo) GetOauth2() VcenterIdentityProvidersOauth2Info {
	if o == nil || o.Oauth2 == nil {
		var ret VcenterIdentityProvidersOauth2Info
		return ret
	}
	return *o.Oauth2
}
...
// SetOauth2 gets a reference to the given VcenterIdentityProvidersOauth2Info and assigns it to the Oauth2 field.
...
func (o *VcenterIdentityProvidersInfo) GetOidc() VcenterIdentityProvidersOidcInfo {
	if o == nil || o.Oidc == nil {
		var ret VcenterIdentityProvidersOidcInfo
		return ret
	}
	return *o.Oidc
}
...
// SetOidc gets a reference to the given VcenterIdentityProvidersOidcInfo and assigns it to the Oidc field.
...
func (o VcenterIdentityProvidersInfo) MarshalJSON() ([]byte, error) {
...
type NullableVcenterIdentityProvidersInfo struct {
	value *VcenterIdentityProvidersInfo
	isSet bool
}

func (v NullableVcenterIdentityProvidersInfo) Get() *VcenterIdentityProvidersInfo {
	return v.value
}

func (v *NullableVcenterIdentityProvidersInfo) Set(val *VcenterIdentityProvidersInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterIdentityProvidersInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterIdentityProvidersInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterIdentityProvidersInfo(val *VcenterIdentityProvidersInfo) *NullableVcenterIdentityProvidersInfo {
	return &NullableVcenterIdentityProvidersInfo{value: val, isSet: true}
}

func (v NullableVcenterIdentityProvidersInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterIdentityProvidersInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
