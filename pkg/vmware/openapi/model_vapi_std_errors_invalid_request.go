...
// VapiStdErrorsInvalidRequest struct for VapiStdErrorsInvalidRequest
type VapiStdErrorsInvalidRequest struct {
...
func NewVapiStdErrorsInvalidRequest(messages []VapiStdLocalizableMessage) *VapiStdErrorsInvalidRequest {
	this := VapiStdErrorsInvalidRequest{}
...
func (o VapiStdErrorsInvalidRequest) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsInvalidRequest struct {
	value *VapiStdErrorsInvalidRequest
	isSet bool
}

func (v NullableVapiStdErrorsInvalidRequest) Get() *VapiStdErrorsInvalidRequest {
	return v.value
}

func (v *NullableVapiStdErrorsInvalidRequest) Set(val *VapiStdErrorsInvalidRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsInvalidRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsInvalidRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsInvalidRequest(val *VapiStdErrorsInvalidRequest) *NullableVapiStdErrorsInvalidRequest {
	return &NullableVapiStdErrorsInvalidRequest{value: val, isSet: true}
}

func (v NullableVapiStdErrorsInvalidRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsInvalidRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
