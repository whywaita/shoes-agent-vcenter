...
// VapiStdErrorsResourceInaccessible struct for VapiStdErrorsResourceInaccessible
type VapiStdErrorsResourceInaccessible struct {
...
func NewVapiStdErrorsResourceInaccessible(messages []VapiStdLocalizableMessage) *VapiStdErrorsResourceInaccessible {
	this := VapiStdErrorsResourceInaccessible{}
...
func (o VapiStdErrorsResourceInaccessible) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsResourceInaccessible struct {
	value *VapiStdErrorsResourceInaccessible
	isSet bool
}

func (v NullableVapiStdErrorsResourceInaccessible) Get() *VapiStdErrorsResourceInaccessible {
	return v.value
}

func (v *NullableVapiStdErrorsResourceInaccessible) Set(val *VapiStdErrorsResourceInaccessible) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsResourceInaccessible) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsResourceInaccessible) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsResourceInaccessible(val *VapiStdErrorsResourceInaccessible) *NullableVapiStdErrorsResourceInaccessible {
	return &NullableVapiStdErrorsResourceInaccessible{value: val, isSet: true}
}

func (v NullableVapiStdErrorsResourceInaccessible) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsResourceInaccessible) UnmarshalJSON(src []byte) error {
	v.isSet = true
