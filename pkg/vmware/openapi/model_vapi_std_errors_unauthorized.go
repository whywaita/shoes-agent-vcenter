...
// VapiStdErrorsUnauthorized struct for VapiStdErrorsUnauthorized
type VapiStdErrorsUnauthorized struct {
...
func NewVapiStdErrorsUnauthorized(messages []VapiStdLocalizableMessage) *VapiStdErrorsUnauthorized {
	this := VapiStdErrorsUnauthorized{}
...
func (o VapiStdErrorsUnauthorized) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsUnauthorized struct {
	value *VapiStdErrorsUnauthorized
	isSet bool
}

func (v NullableVapiStdErrorsUnauthorized) Get() *VapiStdErrorsUnauthorized {
	return v.value
}

func (v *NullableVapiStdErrorsUnauthorized) Set(val *VapiStdErrorsUnauthorized) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsUnauthorized) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsUnauthorized) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsUnauthorized(val *VapiStdErrorsUnauthorized) *NullableVapiStdErrorsUnauthorized {
	return &NullableVapiStdErrorsUnauthorized{value: val, isSet: true}
}

func (v NullableVapiStdErrorsUnauthorized) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsUnauthorized) UnmarshalJSON(src []byte) error {
	v.isSet = true
