...
// VapiStdErrorsUnsupported struct for VapiStdErrorsUnsupported
type VapiStdErrorsUnsupported struct {
...
func (o VapiStdErrorsUnsupported) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsUnsupported struct {
	value *VapiStdErrorsUnsupported
	isSet bool
}

func (v NullableVapiStdErrorsUnsupported) Get() *VapiStdErrorsUnsupported {
	return v.value
}

func (v *NullableVapiStdErrorsUnsupported) Set(val *VapiStdErrorsUnsupported) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsUnsupported) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsUnsupported) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsUnsupported(val *VapiStdErrorsUnsupported) *NullableVapiStdErrorsUnsupported {
	return &NullableVapiStdErrorsUnsupported{value: val, isSet: true}
}

func (v NullableVapiStdErrorsUnsupported) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsUnsupported) UnmarshalJSON(src []byte) error {
	v.isSet = true
