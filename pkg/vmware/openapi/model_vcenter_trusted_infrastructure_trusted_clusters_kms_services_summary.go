...
// VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary struct for VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary
type VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary struct {
...
func NewVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary(service string, address VcenterTrustedInfrastructureNetworkAddress, group string, trustAuthorityCluster string) *VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary {
	this := VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary{}
...
func (o VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) MarshalJSON() ([]byte, error) {
...
type NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary struct {
	value *VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary
	isSet bool
}

func (v NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) Get() *VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary {
	return v.value
}

func (v *NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) Set(val *VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary(val *VcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) *NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary {
	return &NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary{value: val, isSet: true}
}

func (v NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterTrustedInfrastructureTrustedClustersKmsServicesSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
