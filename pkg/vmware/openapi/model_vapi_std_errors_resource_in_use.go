...
// VapiStdErrorsResourceInUse struct for VapiStdErrorsResourceInUse
type VapiStdErrorsResourceInUse struct {
...
func NewVapiStdErrorsResourceInUse(messages []VapiStdLocalizableMessage) *VapiStdErrorsResourceInUse {
	this := VapiStdErrorsResourceInUse{}
...
func (o VapiStdErrorsResourceInUse) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsResourceInUse struct {
	value *VapiStdErrorsResourceInUse
	isSet bool
}

func (v NullableVapiStdErrorsResourceInUse) Get() *VapiStdErrorsResourceInUse {
	return v.value
}

func (v *NullableVapiStdErrorsResourceInUse) Set(val *VapiStdErrorsResourceInUse) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsResourceInUse) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsResourceInUse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsResourceInUse(val *VapiStdErrorsResourceInUse) *NullableVapiStdErrorsResourceInUse {
	return &NullableVapiStdErrorsResourceInUse{value: val, isSet: true}
}

func (v NullableVapiStdErrorsResourceInUse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsResourceInUse) UnmarshalJSON(src []byte) error {
	v.isSet = true
