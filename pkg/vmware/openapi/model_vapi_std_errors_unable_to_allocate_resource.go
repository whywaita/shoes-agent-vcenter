...
// VapiStdErrorsUnableToAllocateResource struct for VapiStdErrorsUnableToAllocateResource
type VapiStdErrorsUnableToAllocateResource struct {
...
func NewVapiStdErrorsUnableToAllocateResource(messages []VapiStdLocalizableMessage) *VapiStdErrorsUnableToAllocateResource {
	this := VapiStdErrorsUnableToAllocateResource{}
...
func (o VapiStdErrorsUnableToAllocateResource) MarshalJSON() ([]byte, error) {
...
type NullableVapiStdErrorsUnableToAllocateResource struct {
	value *VapiStdErrorsUnableToAllocateResource
	isSet bool
}

func (v NullableVapiStdErrorsUnableToAllocateResource) Get() *VapiStdErrorsUnableToAllocateResource {
	return v.value
}

func (v *NullableVapiStdErrorsUnableToAllocateResource) Set(val *VapiStdErrorsUnableToAllocateResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVapiStdErrorsUnableToAllocateResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVapiStdErrorsUnableToAllocateResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVapiStdErrorsUnableToAllocateResource(val *VapiStdErrorsUnableToAllocateResource) *NullableVapiStdErrorsUnableToAllocateResource {
	return &NullableVapiStdErrorsUnableToAllocateResource{value: val, isSet: true}
}

func (v NullableVapiStdErrorsUnableToAllocateResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVapiStdErrorsUnableToAllocateResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
